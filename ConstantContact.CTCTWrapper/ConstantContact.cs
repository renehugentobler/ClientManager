...
namespace CTCT
{
    ...
    public class ConstantContact
    {
        ...
        /// </summary>
        /// <param name="modifiedSince">limit contacts retrieved to contacts modified since the supplied date</param>
        /// <param name="limit">The Record Limit.</param>
        /// <param name="pag">Pagination object.</param>
        /// <returns>Returns a list of contacts.</returns>
        public ResultSet<Contact> GetContacts(DateTime? modifiedSince, int? limit, Pagination pag)
        {
            return ContactService.GetContacts(AccessToken, APIKey, modifiedSince, limit, pag);
        }
        ...
        /// </summary>
        /// <param name="createdSince">filter for activities created since the supplied date in the collection</param>
        /// <param name="limit">Record Count Limit.</param>
        /// <param name="pag">Pagination object.</param>
        /// <returns>ResultSet containing a results array of @link OpenActivity.</returns>
        public ResultSet<OpenActivity> GetCampaignTrackingOpens(int? limit, DateTime? createdSince, Pagination pag)
        {
            return CampaignTrackingService.GetOpens(AccessToken, APIKey, limit, createdSince, pag);
        }
