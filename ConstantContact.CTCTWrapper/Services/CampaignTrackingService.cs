...
namespace CTCT.Services
{
    ...
    public class CampaignTrackingService : BaseService, ICampaignTrackingService
    {
        ...
        /// <param name="pag">Pagination object.</param>
        /// <returns>ResultSet containing a results array of @link OpenActivity.</returns>
        public ResultSet<OpenActivity> GetOpens(string accessToken, string apiKey, int? limit, DateTime? createdSince, Pagination pag)
        {
            return GetOpens(accessToken, apiKey, null, limit, createdSince, pag);
        }
