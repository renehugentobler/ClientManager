...
namespace CTCT.Services
{
    ...
    public class ContactService : BaseService, IContactService
    {
        ...
        /// <param name="pag">Pagination object.</param>
        /// <returns>Returns a list of contacts.</returns>
        public ResultSet<Contact> GetContacts(string accessToken, string apiKey, DateTime? modifiedSince, int? limit, Pagination pag)
        {
            return GetContacts(accessToken, apiKey, null, limit, modifiedSince, null, pag);
        }
