<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LeadsReceiver.aspx.cs" Inherits="Pages_LeadsReceiver" %>
...
--%>
    ...
    <form runat="server">
        ...
        <tbody>
            <tr>
                <td ><asp:TextBox ID="txtError" runat="server" TextMode="MultiLine"></asp:TextBox></td>
            </tr>
        </tbody>
        </table>
    </form>
