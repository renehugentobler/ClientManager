...
public partial class LeadSales2 : System.Web.UI.Page
{
    private Grid grid1;
...
//    static DataTable _dtPriority = new DataTable();
    ...
    void Page_load(object sender, EventArgs e)
    {
        ...
        sdsLeadFlat.SelectCommand = String.Format("SELECT " +
                                                  " l.Id " +
            // " ConstantContactID," +
            // " Customer," +
                                                  " ,l.Name" +
            ...
            // " isdeleted " +
                                                  ...
                                                  " WHERE l.PriorityId = p.Id " +
                                                  "   AND p.Id != 'F3DC2498-6F4F-449E-813C-EFDA32A9D24A' " +
                                                  "   AND l.EMail IN (SELECT email " +
                                                  "                       FROM _cc_email,_cc_list_email,_cc_lists " +
                                                  "                      WHERE list_id = _cc_lists.Id " +
                                                  "                        AND email_id = _cc_email.Id " +
                                                  "                        AND _cc_lists.Name = 'Contest Winners Very Interested') " +
                                                  "   AND l.isdeleted = 0 " +
...
//        grid1.ClientSideEvents.OnClientDblClick = "OnClientDblClick";
    ...
    public void CreateHeadingTemplate(Object sender, Obout.Grid.GridRuntimeTemplateEventArgs e)
    {
        ...
        _listComboBox[0].Items.Add(new ComboBoxItem("Lead Sales 1.0.13x"));
